...
#define UPGRADE_MEM_BASE SHARE_REGION_BASE-0x10000//for bug ioremap for upgrade mem fail.
...
extern int get_debug_gps_sw(void);
extern int ep_get_device_id(char *ver, const int len);
