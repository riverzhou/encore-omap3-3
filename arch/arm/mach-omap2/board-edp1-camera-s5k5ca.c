...
/* <-- LH_SWRD_CL1_Henry@2011.12.1 check back camera power state  */	
bool global_backcamera_power=false;

#if defined(CONFIG_VIDEO_S5K5CA) || defined(CONFIG_VIDEO_S5K5CA_MODULE)

extern int evt_cam_regulator(struct device *dev, int enable);

static void s5k5ca_msleep(unsigned long ms)
{
