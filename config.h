...
# CONFIG_OMAP_SMARTREFLEX_CLASS1P5 is not set
...
CONFIG_CL1_DVT_BOARD=y
# CONFIG_CL1_3G_BOARD is not set
CONFIG_MACH_OMAP3621_EVT1A=y
CONFIG_WLAN_POWER_EVT1=y
# CONFIG_MACH_SDRAM_HYNIX_H8MBX00U0MER0EM_OR_SAMSUNG_K4X4G303PB is not set
# CONFIG_MACH_SDRAM_HYNIX_H8MBX00U0MER0EM is not set
# CONFIG_MACH_SDRAM_SAMSUNG_K4X4G303PB is not set
CONFIG_MACH_SDRAM_ELPIDA_EDK4332C2PB=y
...
# CONFIG_OMAP_FIQ_DEBUGGER is not set
CONFIG_OMAP4_ARM_ERRATA_742230=y
CONFIG_OMAP4_ARM_ERRATA_751472=y
CONFIG_OMAP4_ARM_ERRATA_743622=y
...
CONFIG_RFKILL=y
CONFIG_RFKILL_PM=y
CONFIG_RFKILL_WIFI=y
CONFIG_RFKILL_GPS=y
CONFIG_RFKILL_BT=y
# CONFIG_RFKILL_INPUT is not set
CONFIG_RFKILL_LEDS=y
CONFIG_WIRELESS_BCM4329=y
CONFIG_RFKILL_WIFI_BT_DEFAULT_ON=y
# CONFIG_RFKILL_REGULATOR is not set
# CONFIG_RFKILL_GPIO is not set
# CONFIG_NET_9P is not set
# CONFIG_CAIF is not set
# CONFIG_CAIF_USE_DEPRECATED_FUNC is not set
...
CONFIG_TOUCHSCREEN_FT5_I2C=y
CONFIG_TOUCHSCREEN_MG_I2C=y
CONFIG_INPUT_MISC=y
...
# CONFIG_INPUT_BMA180 is not set
# CONFIG_INPUT_MPU3050 is not set
# CONFIG_INPUT_TSL2771 is not set
CONFIG_SENSOR=y
CONFIG_CM3217_LIGHTSENSOR=y
CONFIG_ADXL345_GSENSOR_MODULE=y
# CONFIG_GSENSOR_AUTO_ROTATION_TEST is not set
CONFIG_VIBRATOR=y
CONFIG_CL1_VIBRATOR=y
...
# CONFIG_TWL6030_MADC is not set
...
# CONFIG_REGULATOR_TPS6130X is not set
# CONFIG_REGULATOR_TPS65023 is not set
# CONFIG_REGULATOR_TPS6507X is not set
CONFIG_REGULATOR_MAX8903=y
CONFIG_REGULATOR_MAX8903_CABLE_TYPE_DETECTION=y
...
# CONFIG_PVR_DUMP_MK_TRACE is not set
...
# CONFIG_HDMI_TI_4XXX_IP is not set
# CONFIG_FB_OMAP_BOOTLOADER_INIT is not set
CONFIG_OMAP2_VRAM=y
CONFIG_OMAP2_VRFB=y
CONFIG_OMAP2_DSS=y
CONFIG_OMAP2_VRAM_SIZE=10
...
# CONFIG_PANEL_TC358765 is not set
CONFIG_PANEL_AT070TNA2=y
CONFIG_DSSCOMP=y
...
CONFIG_SND_SOC_TLV320AIC3111=y
...
# CONFIG_USB_MUSB_HSET is not set
...
CONFIG_USB_VENDOR_ID_LENOVO=y
CONFIG_USB_PRODUCT_ID_A1_07=y
...
CONFIG_CHANGE_INAND_MMC_SCAN_INDEX=y
CONFIG_SIM_CARD_DETECTION=y
# CONFIG_MMC_DW is not set
# CONFIG_MMC_VUB300 is not set
# CONFIG_MMC_USHC is not set
CONFIG_SD_CARD_WAKEUP=y
...
# CONFIG_THERMAL_FRAMEWORK is not set
...
# CONFIG_SECURITY_MIDDLEWARE_COMPONENT is not set
